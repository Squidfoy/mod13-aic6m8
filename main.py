...
# functions to get and validate user input
#note: i will be adding validate funtions to make testing easier
def get_symbol():
...
#commented all this out o do the tests in test_inputs.py
'''
def get_user_input():
    print("Stock Data Visualizer\n-------------------------")
...
def main():
    while(True):
        ...
        time_series, interval = get_time_series()
